      ...
      <section className="px-6 md:px-10 pb-24">
        <div className="max-w-[900px] mx-auto">
          ...
          <Reveal
            as="h1"
            delay={120}
            className="text-4xl md:text-7xl font-extrabold tracking-tighter leading-[0.95]"
          >
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-12 gap-12">
          <aside className="hidden lg:block col-span-3">
            <div className="sticky top-32">
              <div className="text-[10px] font-mono uppercase tracking-[0.3em] text-silver mb-4">
                Содержание
              </div>
              <ul className="space-y-2 text-sm">
                {toc.map((t) => (
                  <li key={t.id}>
                    <a href={`#${t.id}`} className="text-mute hover:text-silver transition-colors">
                      {t.t}
                    </a>
                  </li>
                ))}
          ...
          <article className="col-span-12 lg:col-span-9 space-y-10 text-lg md:text-xl leading-[1.7] text-fg/85">
            ...
            <h2
              id="principle-1"
              className="text-3xl md:text-5xl font-extrabold tracking-tighter pt-6"
            >
              Принцип 1. Тишина
            </h2>
            <p>
            ...
            <blockquote className="border-l-2 border-white/70 pl-8 my-12 text-2xl md:text-4xl font-extrabold tracking-tighter leading-[1.15]">
            ...
            <h2 id="outro" className="text-3xl md:text-5xl font-extrabold tracking-tighter pt-6">
              Финал
            </h2>
            <p>
            ...
            <div className="pt-10">
              <Link
                to="/contact"
                className="premium-button group inline-flex items-center gap-3 px-6 py-3 rounded-full font-bold uppercase tracking-[0.2em] text-xs"
              >
                Обсудить проект{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5">
            {related.map((r, i) => (
              <Reveal key={r.t} delay={i * 80}>
                <Link
                  to="/blog"
                  className="block bg-[#161617] p-8 hover-lift border border-transparent hover:border-white/20 transition-colors h-full"
                >
                  <div className="text-[10px] font-mono uppercase tracking-[0.3em] text-silver mb-6">
                    {r.c}
                  </div>
                  <h3 className="text-xl font-extrabold tracking-tight">{r.t}</h3>
                  <div className="mt-8 inline-flex items-center gap-2 text-silver text-xs uppercase tracking-[0.2em] font-bold">
