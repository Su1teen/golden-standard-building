...
const blog = [
  ...
  },
  {
    ...
    excerpt: "Шесть точек, в которых OPEX уходит вникуда — и где автоматизация даёт мгновенный эффект.",
  },
];
    ...
    <main className="relative">
      ...
      <section className="relative min-h-screen flex flex-col justify-center hero-grad px-6 md:px-10 pt-32 pb-24 overflow-hidden">
        <div className="max-w-[1400px] mx-auto w-full">
          <Reveal className="inline-flex items-center gap-3 text-[11px] font-mono uppercase tracking-[0.3em] text-[#C5A059] mb-10">
            <span className="size-1.5 rounded-full bg-[#C5A059] animate-pulse" />
          ...
          <Reveal delay={450} className="mt-14 flex flex-wrap gap-4">
            <Link
              to="/contact"
              className="group inline-flex items-center gap-3 bg-[#C5A059] text-[#050505] px-7 py-4 rounded-full font-bold uppercase tracking-[0.2em] text-[11px]"
            >
              Обсудить проект
          ...
          <Reveal delay={600} className="mt-24 pt-10 border-t border-white/10 grid grid-cols-2 md:grid-cols-4 gap-10">
      ...
      <section className="py-32 md:py-48 px-6 md:px-10 border-t border-white/5">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 mb-20">
            <Reveal>
              <div className="text-[11px] font-mono uppercase tracking-[0.3em] text-[#C5A059] mb-6">
                Решения · 12
              </div>
            ...
            <Reveal delay={150} className="max-w-[44ch] text-mute leading-relaxed">
              От квартиры до завода. Везде, где пространство встречается с людьми и должно
              работать на них — мы строим систему, которая знает свою задачу.
            </Reveal>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/5">
            {solutions.map((s, i) => (
              ...
              >
                <Link
                  to={s.route}
                  className="bento-card group block aspect-square p-6 md:p-8 border border-transparent"
                >
                  <div className="h-full flex flex-col justify-between relative z-10">
                    <div className="flex items-start justify-between">
                      <span className="font-mono text-[10px] text-mute tracking-widest">{s.index}</span>
                      <ArrowUpRight className="size-4 text-mute group-hover:text-[#C5A059] group-hover:rotate-12 transition-all" />
                    </div>
                    <div>
                      <h3 className="text-xl md:text-2xl font-extrabold tracking-tight">{s.title}</h3>
      ...
      <section className="py-32 md:py-48 px-6 md:px-10">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-7 md:pt-6 space-y-8 text-lg md:text-xl leading-relaxed text-fg/85">
            ...
            <Reveal delay={320}>
              <Link to="/about" className="story-link inline-flex items-center gap-3 text-[#C5A059] font-bold uppercase tracking-[0.2em] text-xs">
      ...
      <section className="py-32 md:py-48 px-6 md:px-10 border-t border-white/5">
        <div className="max-w-[1400px] mx-auto">
          <Reveal className="text-[11px] font-mono uppercase tracking-[0.3em] text-[#C5A059] mb-10">
            Почему мы
          </Reveal>
          <Reveal as="h2" className="text-5xl md:text-7xl font-extrabold tracking-tighter leading-[0.95] mb-24 max-w-[18ch]">
          ...
          <div className="space-y-24">
            {advantages.map((a, i) => (
              ...
              >
                <div className="col-span-12 md:col-span-2 font-mono text-[#C5A059] text-sm">
                  0{i + 1}
                </div>
      ...
      <section className="py-32 md:py-48 px-6 md:px-10 border-t border-white/5">
        <div className="max-w-[1400px] mx-auto">
          ...
          <Reveal as="h2" className="text-5xl md:text-7xl font-extrabold tracking-tighter leading-[0.95] mb-24 max-w-[16ch]">
            От первого звонка<br />до жизни в системе.
          </Reveal>

          <div className="relative grid grid-cols-1 md:grid-cols-6 gap-8 md:gap-4">
            <div className="hidden md:block absolute top-6 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#C5A059]/40 to-transparent" />
            {steps.map((s, i) => (
              <Reveal key={s.t} delay={i * 100} className="relative">
                <div className="relative z-10 size-12 rounded-full bg-[#050505] ring-1 ring-[#C5A059]/50 flex items-center justify-center font-mono text-[12px] text-[#C5A059]">
                  0{i + 1}
                </div>
          ...
          <Reveal delay={400} className="mt-16">
            <Link to="/process" className="story-link inline-flex items-center gap-3 text-[#C5A059] font-bold uppercase tracking-[0.2em] text-xs">
      ...
      <section className="py-32 md:py-48 px-6 md:px-10 border-t border-white/5">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-end justify-between mb-16 gap-10">
            ...
            <Reveal delay={120}>
              <Link to="/blog" className="story-link text-[#C5A059] font-bold uppercase tracking-[0.2em] text-xs">
                Все статьи
              </Link>
            </Reveal>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5">
            {blog.map((p, i) => (
              <Reveal key={p.title} delay={i * 100}>
                <Link
                  to="/blog"
                  className="block bg-[#050505] p-8 md:p-10 hover-lift border border-transparent hover:border-[#C5A059]/30 transition-colors h-full"
                >
                  <div className="text-[10px] font-mono uppercase tracking-[0.3em] text-[#C5A059] mb-8">
                    {p.eyebrow}
                  </div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          <Reveal className="md:col-span-5 md:sticky md:top-32">
            ...
            <div className="mt-12 space-y-3">
              <a href="tel:+77000000000" className="block text-lg story-link">+7 (700) 000 00 00</a>
              <a href="mailto:hello@smartgroup.kz" className="block text-lg story-link">hello@smartgroup.kz</a>
...
function Stat({ to, suffix, label, value }: { to?: number; suffix?: string; label: string; value?: string }) {
  return (
    <div>
      <div className="text-5xl md:text-6xl font-extrabold tracking-tighter text-[#C5A059] leading-none">
