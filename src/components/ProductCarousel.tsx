  ...
  climate: [
    {
      ...
      brand: "HDL / Horizon",
      description: "Умный термостат с сенсорным TFT-дисплеем. Интеграция KNX/BACnet, управление фанкойлом, тёплым полом и приточной вентиляцией.",
    ...
    },
    {
      ...
      brand: "Siemens",
      description: "Контроллер фанкойла с поддержкой BACnet MS/TP. Точная двухзонная регулировка температуры для коммерческих объектов.",
    ...
    },
    {
      name: "CO₂ & IAQ Sensor",
      brand: "Elsner",
      description: "Многофункциональный датчик KNX: CO₂, VOC, влажность, температура. Автоматически запускает вентиляцию при превышении норм.",
    ...
    },
    {
      ...
      description: "Промышленный контроллер чиллера с мониторингом в реальном времени. Оптимизирует потребление энергии до 35%.",
    ...
    },
    {
      ...
      brand: "Systemair",
      description: "Приточно-вытяжная установка с рекуперацией тепла. КПД 85%, интеграция через Modbus RTU и KNX.",
    ...
    },
    {
      ...
      brand: "DEVI / Danfoss",
      description: "Электрический тёплый пол с интеллектуальным расписанием. Поддержка KNX, экономия электроэнергии до 20%.",
  ...
  light: [
    {
      ...
      brand: "Lutron",
      description: "Элегантный настенный диммер Lutron с металлической отделкой. Управляет группами сцен одним касанием, поддержка Caséta и RadioRA.",
    ...
    },
    {
      name: "DALI Gateway",
      brand: "Tridonic",
      description: "DALI-2 шлюз для интеграции профессионального освещения в системы KNX и BACnet. До 64 адресуемых устройств на шину.",
    ...
    },
    {
      ...
      brand: "Iridium / KNX",
      description: "7-дюймовый сенсорный выключатель KNX с OLED-дисплеем. Управление светом, шторами, климатом в одном устройстве.",
    ...
    },
    {
      name: "LED Driver 48V",
      brand: "Mean Well",
      description: "Профессиональный DMX/DALI-совместимый драйвер для архитектурного освещения. Защита IP67, диммирование 0.1–100%.",
    ...
    },
    {
      ...
      brand: "Steinel",
      description: "360° датчик присутствия KNX с детектором движения и освещённости. Автоматизирует свет в переговорных и open-space.",
    ...
    },
    {
      ...
      brand: "Hager",
      description: "KNX привод для управления жалюзи, рулонными шторами и маркизами. Солнечный автомат и защита от ветра.",
  ...
  security: [
    {
      ...
      brand: "Iridium",
      description: "Щит управления Iridium KNX для комплексной автоматизации. Объединяет освещение, безопасность и мультимедиа в единую систему.",
    ...
    },
    {
      ...
      description: "IP-видеодомофон с распознаванием лиц, 8MP камерой и интеграцией в BMS. Открытие двери по лицу без карты.",
    ...
    },
    {
      ...
      brand: "HID Global",
      description: "RFID/BLE-считыватель с поддержкой Mobile Access. Интеграция через OSDP с контроллером доступа Lenel или Genetec.",
    ...
    },
    {
      ...
      brand: "Axis",
      description: "4K IP-камера с аналитикой на борту: толпа, перекрытый выход, оставленные предметы. ONVIF + интеграция в VMS.",
    ...
    },
    {
      ...
      brand: "SALTO / Aperio",
      description: "Беспроводной цилиндровый замок BLE. Mobile key, аварийный режим, интеграция с PMS отеля. Не требует кабельной проводки.",
    ...
    },
    {
      ...
      description: "Адресная пожарная сигнализация с интеграцией BACnet в BMS. Мониторинг 250+ зон, автоматическое дымоудаление.",
  ...
  multimedia: [
    {
      ...
      brand: "Crestron",
      description: "AV-over-IP система передачи 4K/60 по сети 1GbE. Нулевая задержка, шифрование AES-128, матрица до 1000×1000 портов.",
    ...
    },
    {
      ...
      brand: "Sonos Amp",
      description: "Стереоусилитель Sonos 125Вт для мультирум-аудио. Поддержка AirPlay 2, Spotify Connect, интеграция с KNX и Control4.",
    ...
    },
    {
      name: "Control4 EA-5",
      brand: "Control4",
      description: "Центральный контроллер умного дома Control4 EA-5. Управляет аудио, видео, освещением, климатом и безопасностью.",
    ...
    },
    {
      ...
      brand: "Kaleidescape",
      description: "Premium 4K HDR медиаплеер с DTS:X и Dolby Atmos. Библиотека фильмов в максимальном качестве для домашнего кинотеатра.",
    ...
    },
    {
      ...
      brand: "QSC",
      description: "Профессиональная DSP-матрица QSC Q-SYS для коммерческих объектов. 128×128 каналов, AoIP Dante, управление с планшета.",
    ...
    },
    {
      ...
      description: "Моторизованный экран с управлением KNX/RS-232. Zero-G UST-ткань, интеграция в сценарии «Кино», «Конференция».",
